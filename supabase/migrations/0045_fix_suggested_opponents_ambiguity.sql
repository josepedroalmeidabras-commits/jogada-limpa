-- =============================================================================
-- FIX: suggested_opponents ambiguous column references
-- =============================================================================
-- RETURNS TABLE declares team_id, name, photo_url, elo_avg, member_count as
-- output parameters. PL/pgSQL treats these as variables; any unqualified
-- reference to those names inside the function body is ambiguous with the
-- column of the same name in team_elo / teams. Fix: alias inner identifiers
-- and qualify every column reference.
